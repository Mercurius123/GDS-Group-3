...
namespace Opsive.UltimateCharacterController.AddOns.Swimming
{
    ...
    public class Swim : DetectObjectAbilityBase
    {
        ...
        [HideInInspector] [SerializeField] protected Traits.AttributeModifier m_BreathModifier = new Traits.AttributeModifier("Breath", 0, Traits.Attribute.AutoUpdateValue.Decrease);
        ...
        public override void UpdatePosition()
        {
            ...
            if (m_SwimState == SwimStates.SurfaceSwim || m_SwimState == SwimStates.UnderwaterSwim) {
                ...
                if (m_Neck == null && m_SwimState == SwimStates.UnderwaterSwim) {
                    ...
                    m_CharacterLocomotion.AbilityMotor += verticalDirection * m_CharacterLocomotion.InputVector.y * Time.timeScale * m_CharacterLocomotion.TimeScale * Time.deltaTime;
                }
            }
        }
