...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Inventory
{
    ...
    public static class ItemDefinitionAmountInspector
    {
        ...
        public static void OnItemDefinitionAmountElementDraw(SerializedProperty itemIdentifierAmountProperties, Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            objRect.height = 16;
            EditorGUI.PropertyField(objRect, itemIdentifierAmountProperties.GetArrayElementAtIndex(index).FindPropertyRelative("m_ItemDefinition"), new GUIContent());
            ...
            valueRect.height = 16;
            EditorGUI.PropertyField(valueRect, itemIdentifierAmountProperties.GetArrayElementAtIndex(index).FindPropertyRelative("m_Amount"), new GUIContent());
        }
    }
}